...
function Contact() {
  return (
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 lg:px-0 pt-16">
          ...
          <div className="xl:w-2/5 lg:w-2/5 bg-accent py-16 ">
            <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
              ...
              <div className="flex items-center">
                ...
                <p className="pl-4 text-white text-base">041 581 25 43</p>
              </div>
              <div className="flex items-center">
                <div>
                  <svg
                ...
                <p className="pl-4 text-white text-base">info@masifunde.org</p>
              </div>
            </div>
          </div>
          <div className="xl:w-3/5 lg:w-3/5 h-full xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            <form
              id="contact"
