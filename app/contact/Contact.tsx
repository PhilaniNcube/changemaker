          ...
          <div className="py-16 xl:w-2/5 lg:w-2/5 bg-masifunde ">
            <div className="px-8 mx-auto xl:w-5/6 xl:px-0">
              ...
              <h2 className="text-lg font-medium text-white">
                masifunde Changemaker Network MCN Facilitator
              </h2>
              ...
              <div className="flex items-center">
                ...
                <p className="pl-4 text-base text-white">067 603 2400</p>
              </div>{" "}
              <div className="flex items-center">
                <div>
                  <svg
              ...
              <div className="flex items-center">
                ...
                <p className="pl-4 text-base text-white">info@masifunde.org</p>
              </div>
            </div>
          </div>
          <div className="h-full rounded-tr rounded-br xl:w-3/5 lg:w-3/5 xl:pr-5 xl:pl-0">
            ...
            >
              ...
              <div className="w-full mt-6">
                ...
                <SubmitButton className="px-8 py-3 text-sm leading-6 text-white transition duration-150 ease-in-out rounded focus:outline-none bg-masifunde hover:bg-indigo-600">
                  Submit
                </SubmitButton>
              </div>
            </form>
