    ...
    <section className="bg-white pt-10">
      <div className="max-w-7xl mx-auto px-8 lg:px-0 gap-10">
        <p className="text-slate-700 text-justify text-base leading-7 mt-8">
          ...
          violence. The programmes can help guide learners that may be exposed
          to or experiencing violence to find coping skills, positive
          behavioural support, or peer-to-peer education.
        </p>
      </div>
    </section>
  );
