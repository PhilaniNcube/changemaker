...
const sparkMags = [
  ...
  },
  {
    ...
    doc: "/images/national/national_gbv.pdf",
  },
  {
          ...
          <div>
            ...
            <div className="flex flex-col gap-6 md:flex-row">
              ...
              <div className="flex-1">
                ...
                <ul className="pl-6 text-base leading-7 list-disc md:text-base">
            ...
            <div
              id="content"
              className="mt-5 text-base leading-7 text-slate-800 lg:pr-16"
            >
