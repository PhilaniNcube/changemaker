...
export default function Hero() {
  return (
    <div className="relative flex justify-end bg-dark">
      ...
      />
      <div className="absolute inset-0 flex justify-start py-12">
        <div className="max-w-7xl mx-auto flex flex-col items-start w-full">
          ...
          <p className="text-white text-sm md:text-md lg:text-lg align-baseline leading-7 mt-6 max-w-[65ch]">
          ...
          <div className="flex flex-col md:flex-row w-fit gap-3 mt-6 text-black">
            <Link
              href="/changemakers/nmb"
              className="bg-accent text-lg flex flex-col font-medium px-6 py-2.5 w-1/2"
            >
