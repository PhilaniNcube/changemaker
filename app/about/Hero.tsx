...
const Hero = () => {
  return <section className="relative">
    <Image src="/images/school.jpeg" width={6000} height={4000} alt="About" priority className="w-full min-h-screen lg:min-h-fit aspect-[3/1] object-cover" />
    <div className="absolute inset-0 bg-slate-600/80">
      <div className="max-w-7xl mx-auto py-20 px-8 lg:px-0 flex flex-col justify-center items-center text-white h-full">
