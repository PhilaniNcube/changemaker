...
// write a function to get all the text in a sentence after the first word
        ...
        <div className="px-4 mx-auto max-w-7xl md:px-8">
          ...
          <div className="grid gap-6 mt-6 lg:grid-cols-3">
            {transformedListBox?.map((item: ListBoxContent) => (
              ...
              >
                <h4 className="mt-3 text-lg md:text-xl font-medium text-center mb-4">
                  {item.title}
                </h4>
                <p className="font-thin text-balance text-sm">{item.description}</p>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-6 mt-10 text-base text-slate-700 lg:flex-row">
            <div className="max-w-md">
              ...
              <h3 className="mt-4 text-xl font-bold text-slate-950">
                ...
                <br /> {getRestOfText(list.list_title)}
                {/*  */}
              </h3>
            </div>
