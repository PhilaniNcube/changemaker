...
export const schema: { types: SchemaTypeDefinition[] } = {
  types: [homepageHero, homepageContent, hompageTimeline, nmbHero, nmbDescription, nmbFocus,nmbSchools, nmbFunders, nationalHero, nationalDescription,  nationalRoleplayers, nationalFocus, provinceDescription, nationalPartners, nisspHero, nisspDescription, partnerProfiles, provinces],
}
