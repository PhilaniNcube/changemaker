            ...
            <div className="mt-12 w-full px-2 sm:px-6">
              <div className="flex flex-col mt-5">
                ...
                <input
                  ...
                  className="h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-masifunde dark:focus:border-masifunde dark:border-gray-700 dark:text-accent/80 border-gray-300 border shadow"
                  type="email"
                />
              </div>
              <div className="flex flex-col mt-5">
